...
- `CommandComplete`: tag `b'C'`, length, nul-terminated command tag. Tags include `SELECT n`, `INSERT 0 n`, `UPDATE n`, `DELETE n`, `CREATE TABLE`, `DROP TABLE`, `CREATE VIEW`, `DROP VIEW`, `CREATE INDEX`, `DROP INDEX`, `CREATE SEQUENCE`, `DROP SEQUENCE`, `ALTER TABLE`, `EXPLAIN`, `DECLARE CURSOR`, `FETCH n`, `CLOSE CURSOR`, `BEGIN`, `COMMIT`, `ROLLBACK`, `SET`, `SHOW`, `RESET`, `DISCARD ALL`, `VACUUM`, `TRUNCATE TABLE`, and `COPY n`.
