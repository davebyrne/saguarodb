...
- Exclusive checkpoint guard (`begin_checkpoint`, drains all writers, runs alone): checkpoint, implemented maintenance work (`VACUUM`, `TRUNCATE`, and `ALTER TABLE ... SET (...)`), plus autocommit DDL. Readers stay lock-free.
